...
function renderTransition(Component, runTransition, props) {
  ...
  if (runTransition) {
    return (0, import_jsx_runtime.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react8.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime2.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime2.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime2.jsx)(import_jsx_runtime3.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime4.jsxs)(import_jsx_runtime3.Fragment, {
...
var TransitionWrapper = import_react11.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = (0, import_react11.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react11.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react11.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react11.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react11.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react11.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react11.useCallback)(normalize(addEndListener), [addEndListener]);
  return (0, import_jsx_runtime5.jsx)(Transition_default, {
    ...
    ) : import_react11.default.cloneElement(children, {
      ref: attachRef
    })
  });
});
...
var Fade = React6.forwardRef(({
  ...
  const handleEnter = (0, import_react12.useCallback)((node, isAppearing) => {
...
var AbstractModalHeader = React11.forwardRef(({
  ...
  const context = (0, import_react13.useContext)(ModalContext_default);
...
var divWithClassName_default = (className) => React13.forwardRef((p, ref) => (0, import_jsx_runtime13.jsx)("div", {
  ...p,
  ref,
...
var OffcanvasTitle = React14.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React15.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const modalManager = (0, import_react14.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react14.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react14.useState)(false);
  ...
  const modalContext = (0, import_react14.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react14.useCallback)((backdropProps) => (0, import_jsx_runtime15.jsx)("div", {
    ...backdropProps,
...
//# sourceMappingURL=chunk-J6VYS55O.js.map
